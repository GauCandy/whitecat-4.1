...
import { loadEvents } from './bot/loadEvents';
import { loadCommands } from './bot/loadCommands';
...
async function startBot() {
  try {
    ...
    log('\n==========================================', colors.cyan);
    log('WhiteCat Bot is ready!', colors.green);
    log('==========================================\n', colors.cyan);
    ...
    log('\n==========================================', colors.red);
    log('❌ Failed to start WhiteCat Bot', colors.red);
    log('==========================================', colors.red);
...
async function shutdown(signal: string) {
  ...
  try {
    ...
    log('WhiteCat Bot stopped successfully', colors.green);
    process.exit(0);
  } catch (error) {
    const err = error as any;
