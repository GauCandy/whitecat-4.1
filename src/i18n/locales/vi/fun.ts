/**
 * Vietnamese - Fun Commands translations
 */
...
export default {
  ...
  feed: {
    ...
    self: [
      "{user} tự cho mình ăn! 🍔",
      "{user} tự ăn một mình... 😋",
      "{user} đút thức ăn vào miệng mình! Nom nom~ 🍰"
    ],
    bot: [
  ...
  highfive: {
    description: "Vỗ tay với ai đó",
    message: [
      "{user} vỗ tay với {target}! ✋",
  ...
  kiss: {
    ...
    bot: [
      "{user} hôn tớ rồi nè! Ơ dễ thương ghê~ 😊",
      "{user} hôn tớ! Cảm ơn nha~ 🥰",
      "{user} hôn tớ! Bất ngờ quá~ >//< ✨"
    ],
  },
  laugh: {
    description: "Cười",
  ...
  lurk: {
    description: "Ẩn mình trong bóng tối",
    message: [
      "{user} đang rình rập... 👀",
  ...
  pat: {
    description: "Vỗ/xoa đầu ai đó",
    message: [
      "{user} vỗ đầu {target}~ 👋",
      "{user} vỗ vỗ đầu {target}! 🥰",
      "{user} xoa đầu {target}~ ✨",
  ...
  peck: {
    ...
    self: [
      ...
      "{user} hôn gió cho bản thân! 😊",
      "{user} kiss chính mình? Ơ kìa! 😂"
    ],
    bot: [
      "{user} hôn nhẹ tớ! Dễ thương ghê~ 😊",
      "{user} hôn tớ! Cảm ơn nha~ 🥰",
      "{user} kiss tớ nhẹ nhàng! *blush* >//< 😚"
    ],
  },
  poke: {
  ...
  slap: {
    ...
    message: [
      "{user} tát {target}! ✋",
      "{user} tát mạnh {target}! 💥",
      "{user} cho {target} nếm cái tát! 😤",
      "{user} *tát {target}* PAK! ✋💢",
      "{user} tát {target} luôn! (╯°□°)╯",
  ...
  tickle: {
    ...
    self: [
      ...
      "{user} cù bản thân... Ủa có được không nhỉ? 😅",
      "{user} tickle chính mình? Lạ thật! 😂"
    ],
    bot: [
      "{user} cù tớ! Haha! Ngứa quá! 😂",
      "{user} cù tớ! *cười lăn lộn* Dừng lại! 🤣🤣",
      "{user} đừng cù tớ! Vãi ngứa lắm! 😂"
    ],
  },
  wave: {
    ...
    message: [
      ...
      "{user} vẫy tay chào! 👋✨",
      "{user} chào mọi người! 👋😊",
      "{user} *vẫy tay nhiệt tình* Hiii~ ヾ(＾∇＾)",
      "{user} vẫy tay tươi cười! Hello everyone~ 👋💕"
    ],
  },
  wink: {
  ...
  yeet: {
    ...
    self: [
      ...
      "{user} yeet chính mình! Wheee! 🌠",
      "{user} tự ném mình! Ơ kìa là sao ta? 🚀😂"
    ],
    bot: [
      "{user} ném tớ! 🚀",
      "{user} yeet tớ đi! Ơi giời! 😱",
      "{user} ném tớ bay lên trời! Waaah! 🚀💫"
    ],
  },
};
